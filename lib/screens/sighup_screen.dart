...
class _SighupScreenState extends State<SighupScreen> {
  ...
  Future<void> signUp() async {
    ...
    try {
      await _database.sighupUser(email: email, password: password);

      // With email confirmation disabled, signUp already returns a session.
      // If for any reason it didn't, sign in now so the user reaches the
      // Welcome page as a genuinely logged-in user.
      if (_database.currentSession == null) {
